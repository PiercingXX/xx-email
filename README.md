...
| Offline compose | ✅ | Send writes the local outbox; UI says Queued; worker drains when CONNECTED |
...
| New-mail notifications | 🚧 | WorkManager poll (15-min floor); grouped per account in code; **not proven on a device** |
